...
- When:  2026-06-13T03:39:58.804Z

## 🔴 Must fix

- **1 heading(s) on live but missing on local:**
  - h3#- Why We’re Fountain Hills’ Most Trusted Business Broker

- **Structural block mismatch — `article`:** live=3, local=0 (missing 3 on local)


## 🟡 Should fix

- **1 heading(s) on local but not on live (extra):**
  - h3#- What Documentation Is Necessary For The Sale Of Your Business?
